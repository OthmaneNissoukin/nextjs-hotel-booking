...
import { useState, createContext, cloneElement, useContext } from "react";
...
function Overlay({ children }) {
  ...
  return <>{isOpen ? createPortal(<div className={styles.modalOverlay}>{children}</div>, document.body) : null}</>;
}
